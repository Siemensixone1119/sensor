      ...
      fieldset.innerHTML = `
        ...
        <ul class="appeal__list">
          <li class="appeal__list-item">
            <label class="appeal__label" for="product-type-${count}">Тип изделия:</label>
          ...
          <li class="appeal__list-item">
            <label class="appeal__label" for="manufacture-year-${count}">Год выпуска:</label>
          ...
          <li class="appeal__list-item">
            <label class="appeal__label" for="serial-number-${count}">Заводской номер:</label>
            <input required class="appeal__input" type="text" id="serial-number-${count}" placeholder="Указан на шильде или в паспорте">
          </li>
          <li class="appeal__list-item">
            <label class="appeal__label" for="appeal-reason-${count}">Причина обращения:</label>
          ...
          <li class="appeal__list-item">
            <label class="appeal__label" for="short-description-${count}">Краткое описание:</label>
